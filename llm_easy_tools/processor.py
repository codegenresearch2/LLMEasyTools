...
def process_tool_call(tool_call, functions_or_models, prefix_class=None, fix_json_args=True, case_insensitive=False) -> ToolResult:
    ...
    Args:
        ...
        functions_or_models (list[Union[Callable, LLMFunction]]): A list of functions or models to match the tool call.
        prefix_class (Optional[BaseModel]): The class to use as a prefix for the tool call.
        fix_json_args (bool): Whether to fix JSON decode errors in the arguments.
        case_insensitive (bool): Whether to use case-insensitive matching for tool calls.

    Returns:
        ToolResult: The result of the processed tool call.
    """
...
def _is_list_type(annotation):
    try:
        ...
        raise ImportError("The 'get_origin' and 'get_args' functions are not available. Please ensure that you have the necessary typing module imported.")
