...
def process_tool_call(tool_call, functions_or_models, prefix_class=None, fix_json_args=True, case_insensitive=False) -> ToolResult:
    ...
    Args:
        ...
        prefix_class (Optional[BaseModel]): The class to use as a prefix for matching tool calls.
        fix_json_args (bool): Whether to attempt to fix JSON decoding errors in the arguments.
        case_insensitive (bool): Whether to match tool calls in a case-insensitive manner.
...
def process_message(
    ...
    """
    Processes a message from a ChatCompletion response, executing contained tool calls.
    ...
    Args:
        ...
        fix_json_args (bool): Whether to attempt to fix JSON decoding errors in the arguments.
        case_insensitive (bool): Whether to match tool calls in a case-insensitive manner.
        executor (Optional[ThreadPoolExecutor]): An executor to run tool calls in parallel.
